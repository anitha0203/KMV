                    ...
                    >
                      ...
                      >
                        ...
                        <Row lg={12}>
                          ...
                          <Col
                            lg={12}
                            style={{ marginTop: "35px", paddingLeft: "50px",display:"inline-block" }}
                          >
                                        ...
                                        return (
                                           ...
                                           <>
                                              <Col md={3}>
                                                ...
                                                <div style={{position:"absolute",top:"8%",opacity:"0.8",backgroundColor:"white",zIndex:"3",cursor:"pointer"}}>
                                                      <div>
                                                        <i onClick={(e) => {
                                                          e.preventDefault();
                                                          console.log(
                                                          ...
                                                          setPreview(se);
                                                          console.log(se);
                                                        }}className="fa-solid fa-xmark" style={{color:"red",border:"1px solid red",padding:"3px",borderRadius:"5px"}}></i>
                                                     </div>
                                                </div>
